		...
		public static void Setup(GameObject gameObject, AudioClip clip)
		{
			...
			NewConfiguration(OneClickConfiguration.ConfigType.Salsa);
			{
				...
				AddBoneComponent("^CC_Base_Teeth02$",
					...
					"CC_Base_Teeth02",
					false, true, true);
				AddShapeComponent(new []{"^Mouth_Lips_Open.*$"}, 0.11f, 0f, 0.06f, "Mouth_Lips_Open", 0.378f, true);
				AddShapeComponent(new []{"^Mouth_Pucker.*$"}, 0.11f, 0f, 0.06f, "Mouth_Pucker", 0.815f, true);
				...
				AddShapeComponent(new []{"^Mouth_Lips_Open.*$"}, 0.11f, 0f, 0.06f, "Mouth_Lips_Open", 0.319f, true);
				...
				AddShapeComponent(new []{"^Tongue_Out.*$"}, 0.11f, 0f, 0.06f, "Tongue_Out", 1f, true);
				AddShapeComponent(new []{"^Mouth_Blow.*$"}, 0.11f, 0f, 0.06f, "Mouth_Blow", 0.325f, true);
				...
				AddBoneComponent("^CC_Base_Teeth02$",
					...
					"CC_Base_Teeth02",
					false, true, true);
				AddShapeComponent(new []{"^Tongue_Narrow.*$"}, 0.11f, 0f, 0.06f, "Tongue_Narrow", 0.776f, true);
				AddShapeComponent(new []{"^Tongue_Lower.*$"}, 0.11f, 0f, 0.06f, "Tongue_Lower", 1f, true);
				AddShapeComponent(new []{"^Mouth_Lips_Open.*$"}, 0.11f, 0f, 0.06f, "Mouth_Lips_Open", 0.744f, true);
				AddShapeComponent(new []{"^Mouth_Blow.*$"}, 0.11f, 0f, 0.06f, "Mouth_Blow", 0.562f, true);
				...
				AddBoneComponent("^CC_Base_Teeth02$",
					...
					"CC_Base_Teeth02",
					false, true, true);
				AddShapeComponent(new []{"^Mouth_Smile.*$"}, 0.11f, 0f, 0.06f, "Mouth_Smile", 0.408f, true);
				AddShapeComponent(new []{"^Mouth_Widen.*$"}, 0.11f, 0f, 0.06f, "Mouth_Widen", 0.725f, true);
				AddShapeComponent(new []{"^Lip_Open.*$"}, 0.11f, 0f, 0.06f, "Lip_Open", 1f, true);
				AddShapeComponent(new []{"^Mouth_Top_Lip_Up.*$"}, 0.11f, 0f, 0.06f, "Mouth_Top_Lip_Up", 0.15f, true);
				AddShapeComponent(new []{"^Mouth_Bottom_Lip_Down.*$"}, 0.11f, 0f, 0.06f, "Mouth_Bottom_Lip_Down", 0.488f, true);
				...
				AddBoneComponent("^CC_Base_Teeth02$",
					...
					false, true, true);
				AddShapeComponent(new []{"^Tongue_Lower.*$"}, 0.11f, 0f, 0.06f, "Tongue_Lower", 1f, true);
				AddShapeComponent(new []{"^Mouth_Lips_Open.*$"}, 0.11f, 0f, 0.06f, "Mouth_Lips_Open", 0.296f, true);
				AddShapeComponent(new []{"^Mouth_Open.*$"}, 0.11f, 0f, 0.06f, "Mouth_Open", 0.964f, true);
				AddShapeComponent(new []{"^Mouth_Pucker_Open.*$"}, 0.11f, 0f, 0.06f, "Mouth_Pucker_Open", 0.606f, true);
			}
